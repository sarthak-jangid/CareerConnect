...
const Dashboard = () => {
  ...
  // console.log(authState.user?.userId?._id);
            ...
            {postState.posts.map((post) => (
              <div key={post._id} className={styles.singleCard}>
                ...
                <div className={styles.postActions}>
                  <div
                    className={`${styles.likeButton} ${post.hasLiked ? styles.liked : ""}`}
                    onClick={async () => {
                      await dispatch(likePost(post._id));
                      // await dispatch(getAllPosts())
                      await dispatch(getPostLike(post._id));
                    }}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className={styles.likeCount}>{post.likes}</p>
                  </div>
                  ...
                  <div
                    ...
                    onClick={async () => {
                      ...
                      await dispatch(getAllCommentsForPost(post._id));
                    }}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
